<template>
    <q-dialog v-model="isOpen" persistent class="q-pa-md centered-modal">
      <q-card class="modal-card">
        ...
        <q-card-section class="modal-content">
          ...
          <q-btn label="Guardar" @click="guardarNotaCredito" class="q-ml-md full-width"></q-btn>
        </q-card-section>
      </q-card>
    </q-dialog>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      guardarNotaCredito() {
        // Lógica para guardar la nota de crédito (placeholder)
        console.log('Nota de Crédito guardada', this.notaCredito);
      },
    },
  };
  </script>
